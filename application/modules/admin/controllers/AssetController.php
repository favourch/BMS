...
class Admin_AssetController extends Base_Model_ObtorLib_App_Admin_Controller {
    ...
    public function indexAction() {
        try {
            ...
            // get all the country...
            $assetService = new Base_Model_ObtorLib_App_Core_Asset_Service_Asset();
            ...
            if ($this->_request->isPost()) {
               ...
               // $assetEntity->setDateDisposed($this->_request->getParam('txtDateDisposed'));
                ...
                if ($assetId) {
                     ...
                     if($itemPictureName){
                        move_uploaded_file($itemPictureTmpName,APPLICATION_PATH.'/../uploads/images/assets/item-pictures/'.$itemPictureName);
                    }
                    
                    if($attachInvoiceName){
                        move_uploaded_file($attachInvoiceTmpName,APPLICATION_PATH.'/../uploads/images/assets/invoices/'.$attachInvoiceName);
                    }
    ...
    public function viewAction() {
        try {
           ...
           // add new asset information...
            ...
            $logService = new Base_Model_ObtorLib_App_Core_System_Service_Log();
            $logEntity = new Base_Model_ObtorLib_App_Core_System_Entity_Log();
