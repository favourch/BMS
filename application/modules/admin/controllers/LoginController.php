...
class Admin_LoginController extends  Base_Model_ObtorLib_Base_Controller_System {
    ...
    public function indexAction() {
        try {
            ...
            if ($this->_request->isPost()) {
                ...
                $userEntity->setUserPassword(md5($this->_request->getParam('txtPassword')));
                ...
                if (is_null($loggedInUser)) {
                    ...
                    $userLoginHistoryService = new Base_Model_ObtorLib_App_Core_User_Service_UserLoginHistory();
                    $userLoginHistoryEntity = new Base_Model_ObtorLib_App_Core_User_Entity_UserLoginHistory();
