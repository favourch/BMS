...
class Admin_ToDoListController extends Base_Model_ObtorLib_App_Admin_Controller {
    ...
    public function addAction() {
        try {
            ...
            if ($this->_request->isPost()) {
                ...
                if ($toDoListId) {
                    $this->_redirect("/admin/to-do-list/?action-status=updated");
                } else {
                    $this->_redirect("/admin/to-do-list/?action-status=failed");
                }
            }
        } catch (Exception $ex) {
            throw new Exception('<ERROR>' . $ex->getMessage() . "\n");
    ...
    public function deleteAction() {
        try {
            ...
            if ($toDoListId) {
                $this->_redirect("/admin/to-do-list/?action-status=deleted");
            } else {
                $this->_redirect("/admin/to-do-list/?action-status=failed");
            }
        } catch (Exception $ex) {
