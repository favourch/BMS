<?php
class Base_Model_Lib_Ext_Paggination
{
	...
	function __construct() {
		...
		$_RESULT_PER_PAGE 			= $config->pluspro->page->total->rows;
		$_TOTAL_LINKS 				= $config->pluspro->page->total->links;
		$_PAGE_PARAM                = $config->pluspro->page->param;
