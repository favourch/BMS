<?php
Class Base_Model_Lib_Api_Service_EnomInterface
{
  /**
  ...
  * @see        _sslProcess
  */
  public function Base_Model_Lib_Api_Service_EnomInterface($user, $pass, $use_ssl = true, $is_live = false)
  {
    $this->user = $user;
    $this->pass = $pass;
    $this->useSSL = $use_ssl;
  ...
  * @see        _curlHeaders
  */
  public function _sslProcess($url)
  {
  ...
  * @see        addParam
  */
  public function _setCommand($command)
  {
    $this->params = array();
    $this->rawRequest = '';
    $this->rawResponse = '';
  ...
  * @see        _setParseDomain
  */
  public function _isValidSLD($sld)
  {
  ...
  * @see        addParam
  */
  public function _setParseDomain($domainName)
  {
