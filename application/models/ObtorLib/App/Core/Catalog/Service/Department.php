 ...
 */
class Base_Model_ObtorLib_App_Core_Catalog_Service_Department extends Base_Model_ObtorLib_Eav_Model_Service {
    ...
    public function getDepartment($id) {
        try {
            $objDepartment = new Base_Model_ObtorLib_App_Core_Catalog_Dao_Department();
