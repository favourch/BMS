 ...
 */
class Base_Model_ObtorLib_App_Core_Catalog_Service_Region extends Base_Model_ObtorLib_Eav_Model_Service {
    ...
    public function getRegion($id) {
        try {
            $objRegion = new Base_Model_ObtorLib_App_Core_Catalog_Dao_Region();
