 ...
 */
class Base_Model_ObtorLib_App_Core_User_Dao_User extends Zend_Db_Table_Abstract {
     ...
     * @return      : Entity User Object (Base_Model_ObtorLib_App_Core_User_Entity_User)
     */
    ...
    public function getUser($id) {
        try {
            ...
            if ($row) {
                ...
                $userEntity->setUserImage($users['user_image']);
                return $userEntity;
            } else {
                return null;
            }
    ...
    public function addUser() {
        try {
            if (!($this->user instanceof Base_Model_ObtorLib_App_Core_User_Entity_User)) {
                throw new Base_Model_ObtorLib_App_Core_User_Exception(" User Entity not initialized");
            } else {
                $data = array(
    ...
    public function updateUserImage() {
        try {
            if (!($this->user instanceof Base_Model_ObtorLib_App_Core_User_Entity_User)) {
                ...
                $data = array('user_image' => $this->user->getUserImage());
