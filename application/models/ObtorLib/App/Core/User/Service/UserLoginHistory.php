 ...
 * @author anushiya
 */
class Base_Model_ObtorLib_App_Core_User_Service_UserLoginHistory extends Base_Model_ObtorLib_Eav_Model_Service {
    ...
    public function getUserLoginHistory($id) {
        try {
            $objUserLoginHistory = new Base_Model_ObtorLib_App_Core_User_Dao_UserLoginHistory();
    ...
    public function addUserLoginHistory() {
        try {
            if (!($this->userLoginHistory instanceof Base_Model_ObtorLib_App_Core_User_Entity_UserLoginHistory)) {
                throw new Base_Model_ObtorLib_App_Core_User_Exception(" UserLoginHistory Entity not intialized");
            } else {
                $objUserLoginHistory = new Base_Model_ObtorLib_App_Core_User_Dao_UserLoginHistory();
    ...
    public function search($limit = NULL) {
        try {
            if (!($this->userLoginHistory instanceof Base_Model_ObtorLib_App_Core_User_Entity_UserLoginHistory)) {
                ...
                $objUserLoginHistory = new Base_Model_ObtorLib_App_Core_User_Dao_UserLoginHistory();
                $objUserLoginHistory->userLoginHistory = $this->userLoginHistory;
                return $objUserLoginHistory->search($limit);
            }
        } catch (Exception $ex) {
      ...
      public function searchCount() {
        try {
            if (!($this->userLoginHistory instanceof Base_Model_ObtorLib_App_Core_User_Entity_UserLoginHistory)) {
                ...
                $objUserLoginHistory = new Base_Model_ObtorLib_App_Core_User_Dao_UserLoginHistory();
                $objUserLoginHistory->userLoginHistory = $this->userLoginHistory;
                return $objUserLoginHistory->searchCount();
            }
        } catch (Exception $ex) {
            throw new Base_Model_ObtorLib_App_Core_Asset_Exception($ex);
        }
