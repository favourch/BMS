 ...
 */
class Base_Model_ObtorLib_App_Core_User_Service_Role extends Base_Model_ObtorLib_Eav_Model_Service {
    ...
    public function getRole($id) {
        try {
            $objRole = new Base_Model_ObtorLib_App_Core_User_Dao_Role();
