 ...
 */
class Base_Model_ObtorLib_App_Core_Qualification_Service_ProfessionalExperience extends Base_Model_ObtorLib_Eav_Model_Service {
    ...
    public function getProfessionalExperience($id) {
        try {
            $objProfessionalExperience = new Base_Model_ObtorLib_App_Core_Qualification_Dao_ProfessionalExperience();
