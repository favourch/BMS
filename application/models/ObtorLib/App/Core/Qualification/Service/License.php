 ...
 */
class Base_Model_ObtorLib_App_Core_Qualification_Service_License extends Base_Model_ObtorLib_Eav_Model_Service {
    ...
    public function getLicense($id) {
        try {
            $objLicense = new Base_Model_ObtorLib_App_Core_Qualification_Dao_License();
