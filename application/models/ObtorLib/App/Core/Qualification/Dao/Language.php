<?php
class Base_Model_ObtorLib_App_Core_Qualification_Dao_Language extends Zend_Db_Table_Abstract{
    ...
    public function getLanguage($id) {
        try {
            ...
            if ($row) {
                ...
                $languageEntity = new Base_Model_ObtorLib_App_Core_Qualification_Entity_Language();
                ...
                $languageEntity->setRelId($languageRow['rel_id']);
                $languageEntity->setRelObject($languageRow['rel_object']);
        ...
        try {
            if (!($this->language instanceof Base_Model_ObtorLib_App_Core_Qualification_Entity_Language)) {
                ...
                $data = array(
                    ...
                    'rel_id' => $this->language->getRelId(),
                    'rel_object' => $this->language->getRelObject(),
    ...
    public function search() {
        try {
            if (!($this->language instanceof Base_Model_ObtorLib_App_Core_Qualification_Entity_Language)) {
                ...
                $arrWhere = array();
                $arrLanguages = array();
                $relId = $this->language->getRelId();
                $relObject = $this->language->getRelObject();
                ...
                if (count($arrWhere) > 0) {
                    $languageSql.= "WHERE " . implode(' AND ',$arrWhere);
                }
