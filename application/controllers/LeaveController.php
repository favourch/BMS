...
class LeaveController extends Base_Model_ObtorLib_App_Staff_Controller {
    ...
    public function addAction() {
        try {
            ...
            if ($this->_request->isPost()) {
                ...
                $lastUpdatedBy          = $this->getStaffUserId();
                ...
                if ($leaveId) {
                    ...
                    $this->_redirect("/leave/latest-leave-applications/?action-status=updated");
                } else {
                    $this->_redirect("/leave/latest-leave-applications/?action-status=failed");
                }
    ...
    public function editAction() {
        try {
            ...
            if ($this->_request->isPost()) {
                ...
                $objLeaveEntity->setLastUpdatedBy($lastUpdatedBy);
                $objLeaveService->leave = $objLeaveEntity;                
                $isUpdated = $objLeaveService->staffUpdateLeave();
                if ($isUpdated) {
    ...
    public function deleteAction() {
        try {
            ...
            $leaveInformation = $objLeaveService->getLeave($leaveId);
             ...
             $this->_redirect("/leave/latest-leave-applications/?action-status=deleted");
