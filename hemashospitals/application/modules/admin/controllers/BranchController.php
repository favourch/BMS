...
class Admin_BranchController extends Base_Model_Lib_App_Admin_Controller {
    ...
    public function addAction() {
        try {
            ...
            if ($this->_request->isPost()) {
                $branchEntity->setRegion($this->_request->getParam('txtRegion'));
                $branchEntity->setName($this->_request->getParam('txtBranchName'));
