...
class Base_Model_Lib_App_Core_Asset_Dao_Asset extends Zend_Db_Table_Abstract {
     ...
     * @return      : Entity Asset Object (Base_Model_Lib_App_Core_Asset_Entity_Asset)
     */
    ...
    public function addAsset() {
        try {
            if (!($this->asset instanceof Base_Model_Lib_App_Core_Asset_Entity_Asset)) {
                throw new Base_Model_Lib_App_Core_Asset_Exception(" Asset Entity not initialized");
            } else {
                $data = array(
