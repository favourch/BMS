 ...
 */
class Base_Model_Lib_App_Core_Catalog_Service_Category extends Base_Model_Lib_Eav_Model_Service {

    public $category;

    /*
     * Get a user category using id
     * @return      : Entity Category Object (Base_Model_Lib_App_Core_Catalog_Entity_Category)
     */

    public function getCategory($id) {
        try {
            $objCategory = new Base_Model_Lib_App_Core_Catalog_Dao_Category();
    ...
    public function addCategory() {
        try {
            if (!($this->category instanceof Base_Model_Lib_App_Core_Catalog_Entity_Category)) {
                throw new Base_Model_Lib_App_Core_Catalog_Exception(" Category Entity not initialized");
            } else {
                $objCategory = new Base_Model_Lib_App_Core_Catalog_Dao_Category();
