 ...
 */
class Base_Model_Lib_App_Core_Catalog_Service_Country extends Base_Model_Lib_Eav_Model_Service {
    ...
    public function getCountry($id) {
        try {
            $objCountry = new Base_Model_Lib_App_Core_Catalog_Dao_Country();
