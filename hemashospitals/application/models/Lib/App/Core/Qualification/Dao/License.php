<?php
class Base_Model_Lib_App_Core_Qualification_Dao_License extends Zend_Db_Table_Abstract{
    ...
    public function getLicense($id) {
        try {
            ...
            if ($row) {
                ...
                $licenseEntity = new Base_Model_Lib_App_Core_Qualification_Entity_License();
    ...
    public function search() {
        try {
            if (!($this->license instanceof Base_Model_Lib_App_Core_Qualification_Entity_License)) {
                ...
                $arrWhere = array();
                $arrLicenses = array();
                $employeeId = $this->license->getEmployeeId();
                ...
                if (count($arrWhere) > 0) {
                    $licenseSql.= "WHERE " . implode($arrWhere);
                }
