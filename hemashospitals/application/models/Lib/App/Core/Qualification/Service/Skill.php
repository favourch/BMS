 ...
 */
class Base_Model_Lib_App_Core_Qualification_Service_Skill extends Base_Model_Lib_Eav_Model_Service {
    ...
    public function getSkill($id) {
        try {
            $objSkill = new Base_Model_Lib_App_Core_Qualification_Dao_Skill();
