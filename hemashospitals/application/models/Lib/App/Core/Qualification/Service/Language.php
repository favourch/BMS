 ...
 */
class Base_Model_Lib_App_Core_Qualification_Service_Language extends Base_Model_Lib_Eav_Model_Service {
    ...
    public function getLanguage($id) {
        try {
            $objLanguage = new Base_Model_Lib_App_Core_Qualification_Dao_Language();
