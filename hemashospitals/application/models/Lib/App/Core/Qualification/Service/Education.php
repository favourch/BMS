 ...
 */
class Base_Model_Lib_App_Core_Qualification_Service_Education extends Base_Model_Lib_Eav_Model_Service {

    public $education;

    /*
     * Get a user education using id
     * @return      : Entity Education Object (Base_Model_Lib_App_Core_Qualification_Entity_Education)
     */

    public function getEducation($id) {
        try {
            $objEducation = new Base_Model_Lib_App_Core_Qualification_Dao_Education();
    ...
    public function addEducation() {
        try {
            if (!($this->education instanceof Base_Model_Lib_App_Core_Qualification_Entity_Education)) {
                throw new Base_Model_Lib_App_Core_Qualification_Exception(" Education Entity not initialized");
            } else {
                $objEducation = new Base_Model_Lib_App_Core_Qualification_Dao_Education();
