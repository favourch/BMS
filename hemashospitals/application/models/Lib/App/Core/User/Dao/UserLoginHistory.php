 ...
 * @author anushiya
 */
class Base_Model_Lib_App_Core_User_Dao_UserLoginHistory extends Zend_Db_Table_Abstract {
     ...
     * 				  from the database.
     * @param       : $id (User Id)
     * @return      : Entity UserLoginHistory Object (Base_Model_Lib_App_Core_User_Dao_UserLoginHistory)
     */
    ...
    public function addUserLoginHistory() {
        try {
            if (!($this->userLoginHistory instanceof Base_Model_Lib_App_Core_User_Entity_UserLoginHistory)) {
                throw new Base_Model_Lib_App_Core_User_Exception(" UserLoginHistory Entity not initialized");
            } else {
