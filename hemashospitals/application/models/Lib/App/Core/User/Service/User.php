 ...
 */
class Base_Model_Lib_App_Core_User_Service_User extends Base_Model_Lib_Eav_Model_Service {
    ...
    public function getUser($id) {
        try {
            $objUser = new Base_Model_Lib_App_Core_User_Dao_User();
    ...
    public function addUser() {
        try {
            if (!($this->user instanceof Base_Model_Lib_App_Core_User_Entity_User)) {
                throw new Base_Model_Lib_App_Core_User_Exception(" User User Entity not intialized");
            } else {
                $objUser = new Base_Model_Lib_App_Core_User_Dao_User();
